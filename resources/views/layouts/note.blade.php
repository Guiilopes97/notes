        ...
        <div class="card p-4">
            <div class="row">
                <div class="col">
                    ...
                    <small class="text-secondary"><span class="opacity-75 me-2">
                        Created at:
                        </span>
                    ...
                    @if($note['updated_at'] != $note['created_at'])
                        <small class="text-secondary ms-5"><span class="opacity-75 me-2">
                            Updated at:
                            </span>
                            <strong>{{ date('d/m/Y H:i:s', strtotime($note['updated_at'])) }}</strong>
                        </small>
                    @endif
